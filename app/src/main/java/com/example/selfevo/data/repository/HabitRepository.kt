...
class HabitRepository(
    ...
    try {
        ...
        // Preserve the highest value from either local or remote data.
        ...
        // Push local progress back to the server when it is higher.
        val localHasHigherStats =
            resolvedCard.pace > remoteDto.pace ||
        ...
        // Offline fallback: retain the local Room data.
    }
}
    ...
    "DRIBBLING", "SKILL" -> activeCard.copy(
        skill = (activeCard.skill + 1).coerceAtMost(99)
    )
